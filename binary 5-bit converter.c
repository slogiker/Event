...
void binary_to_text(){
    ...
    printf("--------------------------------------------------------------------------------------------------------------------------------------------\n");
    while(1){
    printf("Type in how many letters have your code includive spaces \n");
    scanf("%d", &crke_abecede);

    if(crke_abecede<=0){
        printf("Type in 1 or more\n");
        continue;
    }
    ...
    for(int i=0;i<crke_abecede;i++){
        ...
        rezultat=x1*16+x2*8+x3*4+x4*2+x5*1;
            ...
            if(x1!=0 && x1!=1){
             ...
             if(rezultat==0){
                ...
                crka[i]='q';
            }else if(rezultat>=naj){
                prevec=true;
            }
    }

        if(prevec==true){
            printf("Your letter does not exist\n");
            sleep(1);
            system("CLS");
        }else{
